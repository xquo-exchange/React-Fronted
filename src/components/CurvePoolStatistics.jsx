...
export default function CurvePoolStatistics() {
  ...
  return (
    <div className="pool-container">
      {/* Toggle Header */}
      <div className="pool-toggle-header" onClick={() => setIsExpanded(!isExpanded)}>
        <span className="pool-toggle-title">Pool Statistics</span>
        <span className={`pool-toggle-icon ${isExpanded ? 'expanded' : ''}`}>▼</span>
      </div>
